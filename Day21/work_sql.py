...
# df.to_sql('data.db', con=engine, index_label='ID') # writting to sql
rsql = pd.read_sql('data.db', con=engine, index_col='ID') # reading from sql
# print(rsql)

# filling missing values witl .fillna
